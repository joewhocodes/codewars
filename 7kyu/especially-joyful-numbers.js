...
// integer, never empty, always positive, no special chars
//boolean
// 1729 = true
// 23 false

const numberJoy = n => {
    const reducedNum = String(n).split('').reduce((a, b) => +a + +b);
    return reducedNum * String(reducedNum).split('').reverse().join('') == n;
}

console.log(numberJoy(1729))
console.log(numberJoy(23))